      ...
      <GridItem xs={3} style={{padding: '16px 0px 16px 16px'}}>
        <Paper style={{width: "100%"}}>
          <Tabs style={{height: 48, justifyContent: 'center', borderBottom: '1px solid #2f3749'}}>
            <Tab onClick={() => setSideTab("notes")} current={sideTab == 'notes'}label="Notas" />
            <Tab onClick={() => setSideTab("fixed")} current={sideTab == 'fixed'} label="Fixadas" />
          </Tabs>
