...
export const GET_USER_CONTRIBUTIONS_FAIL = 'GET_USER_CONTRIBUTIONS_FAIL';
export const SEARCH_NEARBY_USERS = 'SEARCH_NEARBY_USERS';
...
export const LOAD_PUBLIC_POSTS_SUCCESS = "LOAD_PUBLIC_POSTS_SUCCESS"
