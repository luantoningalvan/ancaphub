...
const SavedItems = (props) => {
  ...
  return (
    <Template>
      <Box mb={3}>
        <Typography variant="h4" component="h2">Salvos</Typography>
      </Box>

      <Grid container spacing={2}>
        {props.saved && !isEmpty(props.saved) ? props.saved.map(item => (
          <Grid item xs={12} sm={6} md={4} lg={3}>
            ...
            <Grid item xs={12}>
              <Paper>
                <Box p={2}>
                  Você não possui nenhum item salvo.
                </Box>
              </Paper>
            </Grid>
          )}
...
const mapDispatchToProps = (dispatch) => bindActionCreators({ getSaved }, dispatch)
