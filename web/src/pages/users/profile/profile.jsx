  ...
  return (
    <Template>
      ...
      {props.user.user == null ? (
        <Box justifyContent="center" alignItems="center" width={1} height="100%">
          ...
          <Grid container spacing={4}>
            <Grid item xs={3}>
              <Box display="flex" alignItems="center" flexDirection="column" textAlign="center">
                ...
                <Box display="flex" mt={3}>
                  <div style={{ paddingRight: '15px', borderRight: '1px solid #d8d8d8' }}>
                    <MaterialLink component={AdapterLink} to={`/usuario/${_id}/following`}>
                      <Typography variant="body2" style={{ fontWeight: 'bold' }}>{followingCount}</Typography>
                      <Typography variant="subtitle2">Seguindo</Typography>
                    </MaterialLink>
                  </div>
                  <div style={{ paddingLeft: '15px' }}>
                    <MaterialLink component={AdapterLink} to={`/usuario/${_id}/followers`}>
                      <Typography variant="body2" style={{ fontWeight: 'bold' }}>{followersCount}</Typography>
                  ...
                  <List disablePadding>
                    ...
                    {site && (
                      <ListItem>
                        ...
                        <ListItemText
                          primary={<MaterialLink target="_blank" href={site}>{site}</MaterialLink>}
                        />
                      </ListItem>
                    )}
            ...
            <Grid item xs={9}>
              ...
              >
                <Tab component={AdapterLink} to={`/usuario/${_id}/`} label="Feed" value="/usuario/:id" />
                <Tab component={AdapterLink} to={`/usuario/${_id}/collection`} label="Coleção" value="/usuario/:id/collection" />
                <Tab component={AdapterLink} to={`/usuario/${_id}/contributions`} label="Contribuições" value="/usuario/:id/contributions" />
              </Tabs>
